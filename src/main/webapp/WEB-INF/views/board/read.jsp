	...
	<div class="container-fluid">
		<div class="readArea">
			...
			<form class="modifyForm" method="post" action="modify">
				<input type="hidden" name="no" value='${rowNumber}' /> <input class="boardButton" type="submit" value="Modify" />
			</form>
			<form class="deleteForm" method="post" action="delete">
				<input type="hidden" name="no" value='${rowNumber}' /> <input class="boardButton" type="submit" value="Delete" />
			</form>
